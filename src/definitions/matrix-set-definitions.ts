...
import type { MatrixSet2pcName, MatrixSet4pcName, MatrixSetDefinition } from "../models/matrix-set-definition";
...
> = {
  ...
  'Claudia Storm Eye 4pc': {
    id: 'Claudia Storm Eye 4pc',
    displayName: 'Claudia Storm Eye 4pc',
    pieces: 4,
    attackPercentBuffs: [],
    critRateBuffs: [],
    critDamageBuffs: [],
  ...
  "Roslyn 4pc": {
    ...
    attackPercentBuffs: [
      {
        description:
          "After entering Bitter Cold, increase frost ATK for 40 seconds",
        starValues: [
          { star: 0, value: 0.3 },
          { star: 1, value: 0.32 },
          { star: 2, value: 0.34 },
