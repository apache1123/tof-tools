...
export const TwoPiece: Story = {
  args: {
    matrixName: matrixSet2pc.definitionId,
    displayName: matrixSet2pc.displayName,
    pieces: matrixSet2pc.pieces,
    stars: matrixSet2pc.stars,
  },
};

export const FourPiece: Story = {
  args: {
    matrixName: matrixSet4pc.definitionId,
    displayName: matrixSet4pc.displayName,
    pieces: matrixSet4pc.pieces,
